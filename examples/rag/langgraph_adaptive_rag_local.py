...
#get_ipython().system(' pip install -U gpt4all langchain-nomic langchain_community tiktoken langchainhub chromadb langchain langgraph tavily-python')
...
os.environ['LANGCHAIN_API_KEY'] = 'ls__122b3e1c8f474be1b5bfbdb766bf7006'
os.environ['TAVILY_API_KEY'] = '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'
